  ...
  static const _credentials = r'''
{
  ...
  static Worksheet? _custSheet;

  static Future init() async {
    try {
      final spreadsheet = await _gsheets.spreadsheet(_spreadsheetId);
      _custSheet = await _getWorkSheet(spreadsheet, title: 'CustCount');

      final firstRow = CustomerCountFields.getFields();
      _custSheet!.values.insertRow(1, firstRow);
    } catch (e) {
      print('Inti Error : $e');
    }
  }
  ...
  static Future insert(List<Map<String, dynamic>> rowList) async {
    if (_custSheet == null) return;
    _custSheet!.values.map.appendRows(rowList);
  }
}
